...
ADD CONSTRAINT FK_TPDS_ID FOREIGN KEY(ID)
...
SELECT B.ID, B.TITLE,B.TAGNAME,B.CONTENT,B.WDATE,
B.READCOUNT+1,B.LIKECOUNT,B.COMMENTCOUNT,B.SCRAPCOUNT,P.SEQ,P.FILENAME,P.PARENT,B.SEQ
FROM TECHBBS B,TECH_PDS P 
WHERE B.SEQ=P.PARENT AND B.SEQ=20; 
