...
SELECT * FROM LIFEBBS B, (SELECT BBSSEQ, DEL FROM LIFEBBSREPLY WHERE ROWID IN ( SELECT MAX(ROWID) FROM LIFEBBSREPLY GROUP BY DEL, BBSSEQ HAVING DEL=0)) R
WHERE B.SEQ = R.BBSSEQ(+)
*/
