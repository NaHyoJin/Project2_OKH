...
public class QnaAnswerServlet extends HttpServlet {
	...
	public void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(command.equals("write")&&command1.equals("upcon11")) {
			...
			//좋아요,싫어요유무
			boolean likeisS=tservice.isitlikeid(parent, memid);
			boolean dislikeisS=tservice.isitdislikeid(parent, memid);
			...
			if (b) {
				...
				dispatch("qnabbsdetail.jsp", request, response);
			}else {
			...
			//좋아요,싫어요유무
			boolean likeisS=tservice.isitlikeid(bonseq, memid);
			boolean dislikeisS=tservice.isitdislikeid(bonseq, memid);
