...
<%
String actionPath = request.getParameter("actionPath"); // bbs4HWCoding.jsp
...
<input type="hidden" name="findWord" value="<%=findWord%>">
	...
	<ul class="pagination pagination-sm">
		...
		%>
			<a href="#" onclick="gotoPage('<%=firstPage %>')">첫 페이지</a>
		<%
			}
		%>
		</li>
		...
		<%if(nowPage != endPage){
	         ...
	         <li class="step">
	             <a href="#" onclick="gotoPage('<%=totalPage %>')">끝 페이지</a>      <!-- 14페이지 -->
	          </li>
	      </ul>				<!-- totalPage -->
	</div>
</form>